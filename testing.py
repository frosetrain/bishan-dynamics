...
if __name__ == "__main__":
    ...
    # db.settings(straight_speed=450, straight_acceleration=300, turn_acceleration=300, turn_rate=300)
    # linetrack_to_corner("right", 0, min_distance=90)
    # db.straight(95)
    # go_to_slot(0, 1)
    # collect("LONG", "RED")
    # return_from_slot(position["slot"], position["region"])
    # #calibrate_direction(lol)
    ...
    # #push_in(white=True, black=True)

    # db.settings(straight_speed=450, straight_acceleration=500, turn_acceleration=400, turn_rate=200)
    # linetrack_to_corner("right", 90, min_distance=250)
    # linetrack_to_corner("right", 90, min_distance=40)
    # linetrack_to_corner("left", 0, min_distance=100)


    # db.settings(straight_speed=450, straight_acceleration=300, turn_acceleration=300, turn_rate=150)
    # turn_to_line("left_back")
